...
rm(list=ls())
```
That package ill be the e1071 library, which contains statistical learning 
...
data.  Since we set the kernal to linear the decision boundry between the two 
...
you were to count them.  The function below indentifes them.
